...
def main(bottles_dir: pathlib.Path, onnx_path: pathlib.Path):
    ...
    model_onnx_session = dinov3.custom_lib.load.onnx.load_onnx_model(onnx_path)
    model_onnx_wrapper = dinov3.custom_lib.inference.onnx.OnnxInferenceModel(
        onnx_path, model_onnx_session)
...
if __name__ == "__main__":
    ...
    main(bottles_dir, onnx_path=pathlib.Path(args.onnx_path))
